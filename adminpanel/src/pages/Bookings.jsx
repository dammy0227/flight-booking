...
const Bookings = () => {
  ...
  const confirmDelete = () => {
    ...
    dispatch(deleteBooking(deleteConfirm)).then(refresh);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-6.5xl mx-auto px-4 sm:px-6 lg:px-5">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              <select
                ...
                className="px-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 bg-white"
              >
          ...
          <StatCard
            ...
            icon={
              (stats?.flightBookings ?? 0) >= (stats?.hotelBookings ?? 0) ? (
                ...
                <FaHotel className="w-5 h-5 text-blue-600" />
              )
            }
            bgColor="bg-blue-100"
          />
          ...
          <>
            {bookingsArray.length === 0 ? (
              <div className="text-center py-12 sm:py-20 bg-white rounded-xl border border-gray-200">
                <FiCalendar className="mx-auto w-12 h-12 text-gray-400" />
              ...
              <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-700">{formatDate(viewingBooking.createdAt)}</p>
                  </div>
                  <div>
