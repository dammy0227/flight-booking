...
import { registerUser, firebaseLogin } from '../../features/users/userSlice';
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl font-bold text-[#F5F0E8] leading-tight">
              Join the<br />
              <span className="text-[#C9A84C]">Travel Revolution</span>
            </h1>
            <p className="text-[#8B92A5] text-lg leading-relaxed">
              Create your account today and unlock exclusive deals, seamless booking management, and a world of travel possibilities.
            </p>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  <FiUser className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8B92A5] size-5" />
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
              ...
              <div className="my-4">
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  />
                  <div className={`min-w-5 h-5 border-2 rounded-md transition-all mt-0.5 flex items-center justify-center ${
                    agreedToTerms 
                      ? 'bg-[#C9A84C] border-[#C9A84C]' 
                      : 'bg-transparent border-white/20 group-hover:border-white/40'
                  }`}>
                    {agreedToTerms && <FiCheckCircle size={14} className="text-[#0A0E1A]" />}
                  </div>
                  <span className="text-[#8B92A5] text-sm leading-5">
                    I agree to the <span className="text-[#C9A84C] font-semibold hover:opacity-80 cursor-pointer">Terms of Service</span> and{' '}
                    <span className="text-[#C9A84C] font-semibold hover:opacity-80 cursor-pointer">Privacy Policy</span>
                  </span>
                </label>
              </div>
              ...
              <div className="text-center pt-4">
                <p className="text-[#8B92A5]">
                  ...
                  <Link to="/login" className="text-[#C9A84C] font-semibold hover:opacity-80 transition-opacity inline-flex items-center gap-1">
                    Sign In
